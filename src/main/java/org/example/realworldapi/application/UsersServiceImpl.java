...
public class UsersServiceImpl implements UsersService {
	...
	public UsersServiceImpl(UserRepository userRepository, TokenProvider tokenProvider, HashProvider hashProvider) {
	...
	@Override
	public List<User> getFollowingUser(String username) {
		return userRepository.getAllFollowing(username);
	}

	@Override
	public List<User> getAllFollowers(String username) {
		return userRepository.getAllFollowed(username);
	}
